...
#            当前时间段>2:30
#            if not TimeUtils.is_after('14:40:00') > 0 :
#                return None
	    ...
	    is_hit = is_hit & (is_bdouble_red_head)	
...
if __name__ == '__main__':
    ...
    model_close = ModelCloseBRedHead(hist_symbols_days, latest_days[0].day)
    today = latest_days[0]
